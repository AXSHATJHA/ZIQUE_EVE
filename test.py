...
async def chat_endpoint(request: ChatRequest):
    ...
    try:
        ...
        if source.datasource == "general_chatbot":
            ...
            # If no dishes are left after filtering, reset the recommended_dishes set
            ...
            prompt = f"""
                ...
                STRICTLY FOLLOW -> IF THE DIETARY IDENTITY IS VEGETARIAN NEVER SUGGEST SOMETHING THAT HAS CHICKEN, PRAWNS, FISH, EGGS!!(ALWAYS FOLLOW THIS)
